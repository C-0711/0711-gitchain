    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <div className="bg-white rounded-lg p-4 mb-6">
          <pre className="text-sm"><code className="text-emerald-600">{`# TypeScript/JavaScript
...
pip install gitchain`}</code></pre>
        ...
        <p className="text-gray-600 mb-4">
          Navigate to <Link href="/settings" className="text-emerald-600 hover:underline">Settings → API Keys</Link> to 
...
// Output: Verified product data with citations`}</code></pre>
        ...
        <div className="bg-white rounded-lg p-4 mb-6">
          <pre className="text-sm"><code className="text-emerald-600">{`// Create a container
...
// Output: 0711:product:my-company:product-001:v1`}</code></pre>
        ...
        <div className="bg-white rounded-lg p-4 mb-6">
          <pre className="text-sm"><code className="text-emerald-600">{`const verification = await client.verify("0711:product:my-company:product-001:v1");
...
// }`}</code></pre>
        ...
        <div className="mt-12 p-6 bg-emerald-50 border border-emerald-300 rounded-lg">
          <h3 className="font-semibold mb-2">Next Steps</h3>
          <ul className="space-y-2 text-gray-600">
            <li>→ <Link href="/docs/container-types" className="text-emerald-600 hover:underline">Learn about Container Types</Link></li>
            <li>→ <Link href="/docs/inject-api" className="text-emerald-600 hover:underline">Explore the Inject API</Link></li>
            <li>→ <Link href="/docs/verification" className="text-emerald-600 hover:underline">Understand Verification</Link></li>
          </ul>
        </div>
      </div>
    </div>
