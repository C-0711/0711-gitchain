      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "32px 24px" }}>
        ...
        >
          <PageHeader
            ...
            description="Manage your versioned knowledge containers"
          />
          <Link
            href="/containers/new"
            style={{
        ...
        {loading ? (
          ...
          >
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {containers.map((c) => (
                  <tr key={c.uuid || c.id} style={{ borderBottom: `1px solid ${t.border}` }}>
                    <td style={{ padding: "12px 16px" }}>
                      <Link
                        href={`/containers/${c.uuid}`}
                        style={{
                          fontFamily: mono,
                          fontSize: 14,
                          color: t.link,
                      ...
                      {c.name && (
                        <div style={{ fontSize: 13, color: t.fgMuted, marginTop: 2 }}>{c.name}</div>
                      )}
                    </td>
                    <td style={{ padding: "12px 16px" }}>
                      <span style={{ fontSize: 13, color: t.fg, textTransform: "capitalize" }}>
                        {c.type}
                      </span>
                    </td>
                    <td style={{ padding: "12px 16px", textAlign: "right" }}>
                      <span style={{ fontFamily: mono, fontSize: 13, color: t.fg }}>
                        {c.stats?.atoms?.toLocaleString() || 0}
                      </span>
                    </td>
