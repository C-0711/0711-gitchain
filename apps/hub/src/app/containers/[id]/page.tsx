...
const Icon = {
  ...
  Folder: ({ s = 16 }: { s?: number }) => (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor">
      <path d="M1.75 1A1.75 1.75 0 0 0 0 2.75v10.5C0 14.216.784 15 1.75 15h12.5A1.75 1.75 0 0 0 16 13.25v-8.5A1.75 1.75 0 0 0 14.25 3H7.5a.25.25 0 0 1-.2-.1l-.927-1.236A1.75 1.75 0 0 0 4.972 1ZM1.5 2.75a.25.25 0 0 1 .25-.25h3.222a.25.25 0 0 1 .2.1l.927 1.236c.374.498.97.789 1.601.789h6.55a.25.25 0 0 1 .25.25v8.5a.25.25 0 0 1-.25.25H1.75a.25.25 0 0 1-.25-.25Z" />
    </svg>
  ),
  Commit: ({ s = 16 }: { s?: number }) => (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor">
  ...
  Dot: ({ s = 8, color = "#1a7f37" }: { s?: number; color?: string }) => (
  ...
  Robot: ({ s = 16 }: { s?: number }) => (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor">
      <path d="M8 0a1 1 0 0 1 1 1v1h2a3 3 0 0 1 3 3v1h1a1 1 0 1 1 0 2h-1v2h1a1 1 0 1 1 0 2h-1v1a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-1H1a1 1 0 1 1 0-2h1V8H1a1 1 0 0 1 0-2h1V5a3 3 0 0 1 3-3h2V1a1 1 0 0 1 1-1ZM5 3.5A1.5 1.5 0 0 0 3.5 5v8A1.5 1.5 0 0 0 5 14.5h6a1.5 1.5 0 0 0 1.5-1.5V5A1.5 1.5 0 0 0 11 3.5Zm1 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2Zm4 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2Zm-4 4h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1 0-1Z" />
    </svg>
  ),
  Pencil: ({ s = 16 }: { s?: number }) => (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor">
  ...
  Extract: ({ s = 16 }: { s?: number }) => (
    <svg width={s} height={s} viewBox="0 0 16 16" fill="currentColor">
      <path d="M10.5 5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm.061 3.073a4 4 0 1 0-5.123 0 6.004 6.004 0 0 0-3.431 5.142.75.75 0 0 0 1.498.07 4.5 4.5 0 0 1 8.99 0 .75.75 0 1 0 1.498-.07 6.004 6.004 0 0 0-3.432-5.142Z" />
    </svg>
  ),
};
    ...
    >
      {menuItems.map((item, i) => (
        <div key={i}>
          ...
          {item.divider && (
            <div style={{ height: 1, backgroundColor: t.borderSub, margin: "4px 0" }} />
          )}
        </div>
      ))}
    </div>
...
function Trust({ score }: { score: number }) {
  ...
  return (
    <span style={{ fontFamily: mono, fontSize: 12, fontWeight: 600, color: c }}>{score}%</span>
  );
}
    ...
    >
      ...
      <div style={{ padding: 16 }}>
        {tab === "cli" && (
          <div>
            ...
            <div style={{ fontSize: 12, color: t.fgMuted, marginTop: 12, marginBottom: 8 }}>
              Pin to commit:
            </div>
        ...
        {tab === "sdk" && (
          <div>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color: sdkLang === l.id ? t.accent : t.fgMuted,
                    cursor: "pointer",
                    transition: "all 0.1s",
                  }}
                >
            ...
            <CodeBlock
              text={sdkLang === "ts" ? snippets.ts : snippets.python}
              id={sdkLang}
              copied={copied}
              onCopy={copy}
            />
        ...
        {tab === "zip" && (
          <div>
            ...
            >
              <Icon.Download s={14} /> Download ZIP
            </button>
          </div>
        )}
      </div>
      ...
      >
        ...
        >
          {copied === "cid" ? (
            <>
              <Icon.Check s={12} /> Copied
            </>
          ) : (
            <>
              <Icon.Copy s={12} /> Copy ID
            </>
          )}
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.backgroundColor = t.muted;
...
function AtomDetailPanel({ atom, onClose }: { atom: AtomData | null; onClose: () => void }) {
  ...
  const sampleData: Record<string, any> = {
    "product.json": {
      supplier_pid: "8738208680",
      description_short: "CS7000iAW 7 IR-S",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontFamily: mono, fontSize: 15, fontWeight: 600, flex: 1, color: t.fg }}>
          {atom.n}
        </span>
      ...
      >
        <div>
          <span style={{ color: t.fgSubtle }}>Contributor:</span>{" "}
          <span style={{ fontFamily: mono, color: t.fg }}>{atom.c}</span>
        </div>
        <div>
          <span style={{ color: t.fgSubtle }}>Type:</span>{" "}
          <span
            style={{
              fontFamily: mono,
              color: atom.ct === "A" ? t.amber : t.green,
              fontWeight: 600,
            }}
          >
            {atom.ct === "A" ? "AI-generated" : "Original (Mfr)"}
          </span>
        </div>
        <div>
          <span style={{ color: t.fgSubtle }}>Trust:</span> <Trust score={atom.tr} />
        </div>
        <div>
          <span style={{ color: t.fgSubtle }}>Updated:</span>{" "}
          <span style={{ fontFamily: mono, color: t.fgMuted }}>{formatRelativeDate(atom.d)}</span>
        </div>
      </div>
      <div style={{ flex: 1, overflow: "auto", padding: 16 }}>
        {data ? (
          ...
          <div style={{ color: t.fgSubtle, fontSize: 13, textAlign: "center", padding: 40 }}>
...
function CommitsTab() {
  const commits = [
    {
      hash: "e91d4b7",
      message: "AI audit: marketing descriptions + README",
      author: "0711-audit-pipeline",
      authorType: "A",
      date: "Feb 23, 2026",
      stats: { added: 6, modified: 2 },
    },
    {
      hash: "a3f8c12",
      message: "AI audit: efficiency data + ETIM classification",
      author: "0711-audit-pipeline",
      authorType: "A",
      date: "Feb 10, 2026",
      stats: { added: 18, modified: 6 },
    },
    {
      hash: "b7e3201",
      message: "Initial import: BMEcat + media files",
      author: "bosch-thermotechnik",
      authorType: "O",
      date: "Nov 15, 2025",
      stats: { added: 12, modified: 0 },
    },
  ];
  ...
  return (
    <div>
      ...
      >
        <Icon.Commit s={14} />
        <span>
          <strong style={{ color: t.fg }}>3</strong> commits on{" "}
          <strong style={{ color: t.fg }}>main</strong>
        </span>
      </div>
      <div style={{ border: `1px solid ${t.border}`, borderRadius: 8, overflow: "hidden" }}>
        {commits.map((c, i) => (
          <div
            ...
            style={{
              padding: "14px 16px",
              borderBottom: i < commits.length - 1 ? `1px solid ${t.borderSub}` : "none",
              display: "flex",
              alignItems: "center",
              gap: 12,
              backgroundColor: t.bg,
          ...
          >
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 600, fontSize: 14, color: t.fg, marginBottom: 4 }}>
                {c.message}
              </div>
              <div
                style={{
              ...
              >
                <span
                  style={{
                    ...
                    fontSize: 9,
                    fontWeight: 700,
                    backgroundColor: c.authorType === "A" ? t.amberBg : t.subtle,
                    border: `1px solid ${c.authorType === "A" ? t.amberBor : t.border}`,
                    color: c.authorType === "A" ? t.amber : t.fgSubtle,
                  }}
                >
                  {c.authorType}
                </span>
  ...
  return (
    <div>
      ...
      >
        <Icon.PR s={14} />
        <span>
          <strong style={{ color: t.fg }}>0</strong> open pull requests
        </span>
      </div>
      <div
        style={{
      ...
      >
        <div style={{ color: t.fgSubtle, marginBottom: 12 }}>
          <Icon.PR s={28} />
        </div>
        <div style={{ fontSize: 16, fontWeight: 600, color: t.fg, marginBottom: 6 }}>
          No open pull requests
        </div>
        <div style={{ fontSize: 13, color: t.fgMuted, maxWidth: 400, margin: "0 auto" }}>
          Pull requests let contributors propose changes to atoms in this container.
        </div>
        <button
          style={{
            marginTop: 20,
  ...
  return (
    <div>
      ...
      >
        <Icon.Alert s={14} />
        <span>
          <strong style={{ color: t.fg }}>0</strong> active conflicts
        </span>
      </div>
      <div
        style={{
      ...
      >
        <div style={{ color: t.green, marginBottom: 12 }}>
          <Icon.Check s={28} />
        </div>
        <div style={{ fontSize: 16, fontWeight: 600, color: t.fg, marginBottom: 6 }}>All clear</div>
        <div style={{ fontSize: 13, color: t.fgMuted, maxWidth: 400, margin: "0 auto" }}>
          No conflicting data detected between manufacturer data and AI-generated atoms.
        </div>
      </div>
    </div>
  );
    ...
    <div>
      ...
      >
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <Icon.Dot s={8} color={t.accent} /> Current
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <Icon.Dot s={8} color={t.purple} /> Family
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <Icon.Dot s={8} color={t.green} /> Compatible
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <Icon.Dot s={8} color={t.fgSubtle} /> Replaced by
        </span>
      </div>
      <div
        style={{
        ...
        <svg width="100%" height="380" viewBox="0 0 660 380" style={{ display: "block" }}>
          <defs>
            <marker id="arrowGray" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
              <polygon points="0 0, 8 3, 0 6" fill={t.fgSubtle} />
            </marker>
          </defs>
          {edges.map((e, i) => {
            ...
            return (
              <line
                ...
                strokeWidth={1.5}
                strokeDasharray={e.type === "replaced" ? "4 3" : "none"}
                markerEnd={e.type === "replaced" ? "url(#arrowGray)" : ""}
                opacity={0.6}
              />
            );
          })}
          {nodes.map((n) => (
            <g key={n.id} style={{ cursor: "pointer" }}>
              ...
              <text
                x={n.x}
                y={n.y + (n.type === "current" ? 24 : 20)}
                textAnchor="middle"
                fontSize={11}
                fontFamily={mono}
                fill={t.fg}
                fontWeight={n.type === "current" ? 700 : 400}
              >
                {n.label}
              </text>
            </g>
      ...
      >
        <span>
          <strong style={{ color: t.fg }}>3</strong> family variants
        </span>
        <span>
          <strong style={{ color: t.fg }}>44</strong> compatible products
        </span>
        <span>
          <strong style={{ color: t.fg }}>1</strong> predecessor
        </span>
      </div>
    </div>
  );
...
// --- Version/Commit Selector ---
function VersionSelector({ container }: { container: any }) {
  ...
  const currentVersion = container?.version || 3;
  const commits = [
    {
      hash: "e91d4b7",
      version: 3,
  ...
  return (
    <div ref={ref} style={{ position: "relative", display: "inline-flex" }}>
      <button
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.backgroundColor = t.muted;
          e.currentTarget.style.borderColor = t.fgSubtle;
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.backgroundColor = t.subtle;
          e.currentTarget.style.borderColor = t.border;
        }}
      >
        <Icon.Tag s={14} />
        <span>v{currentVersion}</span>
        <span style={{ color: t.fgSubtle, fontSize: 11 }}>({commits[0].hash})</span>
        <Icon.Chev s={12} />
      </button>
      ...
      {open && (
        ...
        >
          ...
          {commits.map((c, i) => (
            <button
              ...
              style={{
                ...
                gap: 10,
                padding: "10px 14px",
                background: c.current ? t.muted : "none",
                border: "none",
                borderBottom: i < commits.length - 1 ? `1px solid ${t.borderSub}` : "none",
                cursor: "pointer",
                textAlign: "left",
              ...
              onMouseEnter={(e) => {
                if (!c.current) e.currentTarget.style.backgroundColor = t.muted;
              }}
              onMouseLeave={(e) => {
                if (!c.current) e.currentTarget.style.backgroundColor = "transparent";
              }}
            >
              {/* Version badge */}
              <span
                style={{
                  ...
                  fontFamily: mono,
                  borderRadius: 4,
                  backgroundColor: c.current ? t.amberBg : t.subtle,
                  color: c.current ? t.accent : t.fgMuted,
                  border: `1px solid ${c.current ? t.amberBor : t.border}`,
                  flexShrink: 0,
                  marginTop: 1,
                }}
              >
          ...
          >
            <Icon.Clock s={12} />
            <span>{commits.length} versions available</span>
          </div>
        </div>
      )}
    </div>
...
function AIStatus({ analyzed }: { analyzed: boolean }) {
  ...
  return (
    <span
      style={{ display: "inline-flex", alignItems: "center", gap: 4, color: t.green, fontSize: 12 }}
    >
...
function AtomRow({ a, last, onClick }: { a: AtomData; last: boolean; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: fileColor, flexShrink: 0 }}>
          <Icon.File s={16} />
        </span>
        <span
          style={{
      ...
      <span style={{ textAlign: "right" }}>
        <button
          ...
          onMouseLeave={(e) => {
            ...
            e.currentTarget.style.color = t.fgSubtle;
          }}
        >
          <Icon.MoreVert s={16} />
        </button>
...
export default function ContainerPage() {
  ...
  if (error) {
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 18, color: t.red, marginBottom: 16 }}>{error}</div>
          <a href="/containers" style={{ color: t.accent, textDecoration: "none", fontSize: 14 }}>
            Back to containers
          </a>
          <span style={{ color: t.fgSubtle, margin: "0 12px" }}>·</span>
          <a href="/dashboard" style={{ color: t.accent, textDecoration: "none", fontSize: 14 }}>
            Dashboard
          </a>
        </div>
      </div>
      ...
      >
        ...
        >
          <span style={{ fontFamily: mono, fontSize: 17 }}>
            ...
            <a href="#" style={{ color: t.accent, textDecoration: "none", fontWeight: 700 }}>
              {container?.identifier || "..."}
            </a>
          </span>
          <VersionSelector container={container} />
        </div>
        <p style={{ fontSize: 14, color: t.fgMuted, margin: "6px 0 14px" }}>
          <strong style={{ color: t.fg }}>{container?.name || "Loading..."}</strong> —{" "}
          {container?.description || ""}
          {container?.etim?.class_code ? ` · ETIM ${container.etim.class_code}` : ""}
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <span>
            Trust:{" "}
            <strong style={{ color: t.fg }}>{container?.stats?.trustManufacturer || 0}%</strong> mfr
            / <strong style={{ color: t.fg }}>{container?.stats?.trustAi || 0}%</strong> ai
          </span>
          <span style={{ color: t.border }}>·</span>
          <span>
            <strong style={{ color: t.fg }}>{container?.stats?.atoms || 0}</strong> atoms
          </span>
          <span style={{ color: t.border }}>·</span>
          <span>
            <strong style={{ color: t.fg }}>{container?.stats?.mediaFiles || 0}</strong> media
          </span>
          <span style={{ color: t.border }}>·</span>
          <span>
            <strong style={{ color: t.fg }}>{container?.stats?.family || 0}</strong> family
          </span>
          <span style={{ color: t.border }}>·</span>
          <span>
            <strong style={{ color: t.fg }}>{container?.stats?.compatible || 0}</strong> compatible
          </span>
          <span style={{ color: t.border }}>·</span>
          <Badge
            label={`${container?.stats?.qualityScore || 0}% ${container?.stats?.qualityGrade || "?"}`}
            variant="success"
          />
        </div>
          ...
          {tabs.map((tb) => (
            <button
              ...
              style={{
                ...
                padding: "10px 18px",
                fontSize: 14,
                fontWeight: activeTab === tb.id ? 600 : 400,
                color: activeTab === tb.id ? t.fg : t.fgMuted,
                background: "none",
                border: "none",
                borderBottom:
                  activeTab === tb.id ? `2px solid ${t.tabLine}` : "2px solid transparent",
                cursor: "pointer",
                transition: "color 0.1s",
              }}
              onMouseEnter={(e) => {
                if (activeTab !== tb.id) e.currentTarget.style.color = t.fg;
              }}
              onMouseLeave={(e) => {
                if (activeTab !== tb.id) e.currentTarget.style.color = t.fgMuted;
              }}
            >
              {tb.icon}
              {tb.label}
          ...
          <>
            ...
            >
              <button
                ...
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = t.subtle)}
              >
                <Icon.Branch s={14} /> main <Icon.Chev s={12} />
              </button>
              <span style={{ fontFamily: mono, fontSize: 13, color: t.fgMuted }}>
                <span style={{ color: t.accent }}>b7e3201</span> · Initial import: BMEcat + media
                files… · 2025-11-15
              </span>
                ...
                if ("folder" in item) {
                  ...
                  return (
                    <div key={item.folder}>
                      <div
                        onClick={() =>
                          setFolders((p) => ({ ...p, [item.folder]: !p[item.folder] }))
                        }
                        style={{
                          display: "grid",
                          gridTemplateColumns: "1fr 100px 70px 90px 40px",
      ...
      {selectedAtom && (
        <>
          <div
            ...
            style={{ position: "fixed", inset: 0, backgroundColor: t.overlay, zIndex: 199 }}
          />
