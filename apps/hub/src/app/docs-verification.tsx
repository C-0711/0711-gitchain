      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="bg-gray-900 rounded-lg p-6">
            <pre className="text-sm text-gray-300">{`Container Data
      ↓
┌─────────────────┐
...
└─────────────────┘`}</pre>
        ...
        <section>
          ...
          <div className="bg-gray-900 rounded-lg p-4 mb-4">
            <pre className="text-sm"><code className="text-emerald-400">{`const verification = await client.verify("0711:product:acme:widget-001:v1");
  ...
  "merkle": {
    ...
    "index": 7
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-400">
            ...
            <li>Confirming the transaction on <a href="https://basescan.org" target="_blank" rel="noopener" className="text-emerald-400 hover:underline">Basescan</a></li>
          </ol>
        </section>
        ...
        <section>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
            ...
            <div className="font-mono text-emerald-400 text-sm break-all mb-4">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener"
              className="inline-block px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded text-sm transition"
            >
              View on Basescan →
            </a>
          </div>
