...
export default function NamespacesPage() {
  ...
  const fetchNamespaces = async () => {
    try {
      const res = await fetch("/api/namespaces").catch(() => null);
      if (res?.ok) {
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <h2 className="text-xl font-semibold mb-2">No namespaces yet</h2>
          <p className="text-gray-400 mb-6">Create your first namespace to organize containers</p>
          <Link
            href="/namespaces/new"
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    {ns.containerCount.toLocaleString()} container{ns.containerCount !== 1 ? "s" : ""}
                  </p>
                </div>
